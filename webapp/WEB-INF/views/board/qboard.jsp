...
<div class="container">
	...
	<div class="span9">
    	<table class="table table-striped table-hover ">
            ...
            <tr class="active">
            	<td>${vo.qboardno}</td>
                <td id="title"><a href="/railway999/qboard/viewform?qboardno=${vo.qboardno}">${vo.title }</a></td>
		...
		<div> 
            ...
            <div class="offset8">
            <a href="/railway999/qboard/insertform" class="btn btn-primary">글쓰기</a><br><br><br><br>
            </div>
	</div>       
	<!-- Footer import -->		
