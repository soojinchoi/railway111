...
<div class="container">
	...
	<div class="span9">
    	<table class="table table-striped table-hover ">
            ...
            <tr class="notice">
            	<td>4</td>
                <td id="title"><a href="/railway999/views/board/qboardviewform.jsp"><strong>[공지]&nbsp;&nbsp;&nbsp;</strong>하이하이 이 글은 공지라능</a></td>
		...
		<div> 
            ...
            <div class="offset8">
            <a href="/railway999/qboard/insert" class="btn btn-primary">글쓰기</a><br><br><br><br>
            </div>
	</div>       
	<!-- Footer import -->		
